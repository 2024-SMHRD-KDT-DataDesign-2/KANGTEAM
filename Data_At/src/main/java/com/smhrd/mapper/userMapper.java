...
public interface userMapper {
   ...
   @Update("update tb_user set user_credit = #{user_credit} where user_id = #{user_id} ")
   public int usecredit(@Param("user_id")String user_id,@Param("user_credit") int user_credit);
}